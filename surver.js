...
// Fonction pour creer une personne
...
// Fonction pour chercher par nom de personne
const findOnePerson = async (personName) => {
  ...
  // Fonction pour rechercher avec méthode findOne the favotieFood
const findOneFood = async (food) => {
  ...
  // rechercher avec _id de personne
  ...
  // trouver une personne par ID, ajouter une nourriture favorite et enregistrer dans la base de données
